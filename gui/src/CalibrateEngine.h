...
class CalibrateEngine : public QObject {
  ...
  public:
    ...
    Q_INVOKABLE void stereoCalibrate(const int targetType, const int rowNum, const int colNum,
                                       const float trueDistance, const bool exportAsLC = false);
    ...
    Q_INVOKABLE void bindLeftCameraModel(CameraModel* cameraModel) { leftCameraModel_ = cameraModel; };
    Q_INVOKABLE void bindRightCameraModel(CameraModel* cameraModel) { rightCameraModel_ = cameraModel; };
