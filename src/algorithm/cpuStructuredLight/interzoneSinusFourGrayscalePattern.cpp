...
namespace slmaster {
namespace algorithm {
class InterzoneSinusFourGrayscalePattern_Impl final : public InterzoneSinusFourGrayscalePattern {
  public:
    // Constructor
...
InterzoneSinusFourGrayscalePattern_Impl::InterzoneSinusFourGrayscalePattern_Impl(
    const InterzoneSinusFourGrayscalePattern::Params &parameters)
    : params(parameters) {}
...
bool InterzoneSinusFourGrayscalePattern_Impl::generate(OutputArrayOfArrays pattern) {
...
Ptr<InterzoneSinusFourGrayscalePattern> InterzoneSinusFourGrayscalePattern::create(
