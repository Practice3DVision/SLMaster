...
#ifndef __SINUSOIDAL_COMPLEMENTARY_GRAYCODE_PATTERN_HPP_
#define __SINUSOIDAL_COMPLEMENTARY_GRAYCODE_PATTERN_HPP_
...
class SLMASTER_API SinusCompleGrayCodePattern : public StructuredLightPattern {
  public:
     ...
     */
    virtual void
    unwrapPhaseMap(cv::InputArray wrappedPhaseMap, cv::InputArray floorMap, cv::InputArray confidenceMap,
